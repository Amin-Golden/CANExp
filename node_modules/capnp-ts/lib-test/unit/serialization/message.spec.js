(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../../lib/constants", "../../../lib/serialization", "../../../lib/serialization/arena", "../../../lib/serialization/message", "../../integration/serialization-demo", "../../util"], factory);
    }
    ...
    util_1.tap.test('getFramedSegments()', function (t) {
        t.throws(function () { return message_1.getFramedSegments(new Uint8Array([
            0x00, 0x00, 0x00, 0x00,
