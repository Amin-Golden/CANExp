...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../../lib/serialization/packing", "../../util"], factory);
    }
    ...
    var TAG_DATA = [
        { tag: 0, weight: 0, word: [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00] },
        { tag: 49, weight: 3, word: [0x09, 0x00, 0x00, 0x00, 0x04, 0x01, 0x00, 0x00] },
        { tag: 1, weight: 1, word: [0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00] },
        { tag: 255, weight: 8, word: [0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff] },
        { tag: 128, weight: 1, word: [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff] },
        { tag: 255, weight: 8, word: [0x0a, 0x15, 0x01, 0xac, 0x6d, 0x9f, 0x03, 0xf2] },
        { tag: 63, weight: 6, word: [0x41, 0x53, 0x53, 0x48, 0x41, 0x54, 0x00, 0x00] },
    ];
    ...
    util_1.tap.test('getZeroByteCount()', function (t) {
        t.plan(TAG_DATA.length);
        TAG_DATA.forEach(function (d) { return t.equal(packing_1.getZeroByteCount.apply(null, d.word), 8 - d.weight); });
        t.end();
    });
