...
export declare function getData(index: number, s: Struct): Data;
...
export declare function getList<T>(index: number, ListClass: ListCtor<T>, s: Struct): List<T>;
...
export declare function getStruct<T extends Struct>(index: number, StructClass: StructCtor<T>, s: Struct): T;
export declare function getText(index: number, s: Struct): string;
/**
